...
function consult_fonts_url () {
	$fonts_url = '';
	 ...
	 if ('off' !==  $OpenSans || 'off' !== $Montserrat){
		...
		if ('off' !==  $OpenSans) {
		   $font_families[]='Mostserrat:200,300,400,500,600,700,800,900';
		}

		$query_args = array (
			'family' => urlencode (implode('|', $font_families)),
			'subset' => urlencode ('cyrillic-ext,cyrillic,vietnamese,latin-ext, latin,greek,greek-ext'),
		);
...
function consult_custom_header_fonts() {
	wp_enquene_style ('OpenSans', '//fonts.googleapis.com/css?family=Open+Sans:300i,400,400i,600,700,800', array(), null );
	wp_enquene_style ('Montserrat', '//fonts.googleapis.com/css?family=Montserrat:200,300,400,500,600,700,800,900', array(), null );
}

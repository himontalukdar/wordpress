        ...
        <div id="home_default" class="rev_slider fullscreenbanner" style="display:none;">
            <ul>
                <li data-index="digital_slide_1" data-transition="crossfade" data-slotamount="default"  data-easein="default" data-easeout="default" data-masterspeed="500"  data-rotate="0"  data-saveperformance="off"  data-title="Focus">
                    ...
                    <img src="<?php echo get_template_directory_uri();?>/images/slider_img_01.jpg" alt="<?php echo get_template_directory_uri();?>/images"  data-lazyload="" data-bgposition="center center" data-bgfit="cover" data-bgrepeat="no-repeat" data-bgparallax="off" class="rev-slidebg" data-no-retina>
                ...
                <li data-index="digital_slide_2" data-transition="crossfade" data-slotamount="default"  data-easein="default" data-easeout="default" data-masterspeed="500"  data-rotate="0"  data-saveperformance="off"  data-title="Focus">
                    ...
                    <img src="<?php echo get_template_directory_uri();?>/images/slider_img_02.jpg" alt="<?php echo get_template_directory_uri();?>/images"  data-lazyload="" data-bgposition="center center" data-bgfit="cover" data-bgrepeat="no-repeat" data-bgparallax="off" class="rev-slidebg" data-no-retina>
            ...
            <div class="row">
                ...
                <div class="col-md-6">
                    <div class="looking_for_right image_fulwidth wow fadeInRight" data-wow-delay="300ms">
                        <img src="<?php echo get_template_directory_uri();?>/images/we_are_alwayes.jpg" alt="<?php echo get_template_directory_uri();?>/images">
                    </div>
                </div>
            </div><!--row -->
        </div><!--container -->
            ...
            <div class="row">
                <div class="col-md-4 col-sm-6">
                    <div class="choose_us_single para_default image_fulwidth text-center wow fadeInLeft" data-wow-delay="300ms">
                        <img src="<?php echo get_template_directory_uri();?>/images/why_choos_us_01.jpg" alt="<?php echo get_template_directory_uri();?>/images">
                ...
                <div class="col-md-4 col-sm-6">
                    <div class="choose_us_single para_default image_fulwidth text-center wow fadeInLeft" data-wow-delay="500ms">
                        <img src="<?php echo get_template_directory_uri();?>/images/why_choos_us_02.jpg" alt="<?php echo get_template_directory_uri();?>/images">
                        <h3>Consultancy services</h3>
                        <p>Lorem ipsum dolor sit amet, elit. Donec nec ornare purus. Nulla non augue ut mi mollis eget id arcu. Rem autem voluptatem</p>
                    </div>
                </div><!--col-md-4 -->
                ...
                <div class="col-md-4 col-sm-6">
                    <div class="choose_us_single para_default image_fulwidth text-center wow fadeInLeft" data-wow-delay="700ms">
                        <img src="<?php echo get_template_directory_uri();?>/images/why_choos_us_03.jpg" alt="<?php echo get_template_directory_uri();?>/images">
                        <h3>Consultancy services</h3>
                        <p>Lorem ipsum dolor sit amet, elit. Donec nec ornare purus. Nulla non augue ut mi mollis eget id arcu. Rem autem voluptatem</p>
                    </div>
                </div><!--col-md-4 -->
                ...
                <div class="col-md-4">
                    <div class="single_blog_h_active">
                        <div class="single_blog_item_area para_default image_fulwidth text-center">
                            <a href="#"><img src="<?php echo get_template_directory_uri();?>/images/latest_blog_01.jpg" alt="<?php echo get_template_directory_uri();?>/images"></a>
                            <h4>25 JUNE 2016</h4>
